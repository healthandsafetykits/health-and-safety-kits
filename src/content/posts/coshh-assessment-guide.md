...
1. **Look at the label.** If a product carries any of the CLP (Classification, Labelling and Packaging) hazard symbols — the red-bordered diamond shapes — it is classified as hazardous. Common symbols include the exclamation mark (irritant), the health hazard silhouette (serious health effects), the flame (flammable), and the corrosion symbol.

2. **Check the Safety Data Sheet (SDS).** Every chemical product supplier is legally required to provide an SDS. Section 2 of the SDS tells you exactly what the hazards are.
...
1. **Elimination** — can you stop using this substance altogether?
2. **Substitution** — can you replace it with something less hazardous?
3. **Engineering controls** — can you use ventilation, extraction, or enclosed systems to reduce exposure?
4. **Administrative controls** — can you reduce exposure through procedures, training, or limiting the time people spend working with the substance?
5. **Personal Protective Equipment (PPE)** — gloves, masks, goggles, aprons
...
Our [compliance kits](/kits/) include pre-formatted COSHH assessment templates with common substances already listed for your trade. Just review, customise, and you are compliant.
...
2. **Hazards identification** — classification and hazard statements
3. **Composition/information on ingredients** — what is in it
4. **First-aid measures** — what to do if someone is exposed
5. **Fire-fighting measures** — how to deal with a fire involving the product
6. **Accidental release measures** — how to clean up a spill
7. **Handling and storage** — safe working practices and storage conditions
8. **Exposure controls/personal protection** — workplace exposure limits and PPE requirements
9. **Physical and chemical properties** — appearance, odour, boiling point, etc.
10. **Stability and reactivity** — what it reacts with and what to keep it away from
...
14. **Transport information** — classification for transport
15. **Regulatory information** — applicable legislation
...
- **Section 4: First-aid measures** — tells you what to do if exposure occurs. This information goes straight into your emergency procedures.

- **Section 7: Handling and storage** — tells you the precautions to take during use and how to store the product safely. This informs your control measures.

- **Section 8: Exposure controls/personal protection** — tells you the workplace exposure limits (if any) and what PPE to use. This is critical for choosing the right gloves, masks, and other protective equipment.
...
See what a properly completed COSHH assessment looks like — download our [free sample](/free-sample/).
...
For more information about how COSHH assessments fit into your overall compliance picture, see our [health and safety compliance checklist](/blog/health-and-safety-compliance-checklist/) and our guide to [health and safety risk assessments](/blog/health-and-safety-risk-assessment-guide/).
...
1. **Audit your substances.** Walk through your workplace and list every hazardous substance — including the ones you think are harmless.

2. **Collect your Safety Data Sheets.** Contact your suppliers if you do not have them. You cannot complete a proper assessment without them.

3. **Work through the 6-step process.** Inventory, SDS, exposure, risk, controls, record. Take it one substance at a time.

4. **Follow the hierarchy of controls.** Eliminate and substitute before reaching for PPE. Document your reasoning.

5. **Train your team.** Everyone who works with hazardous substances must know the risks and the controls.

6. **Review regularly.** At least annually, and whenever something changes.

7. **Keep your records.** Five years minimum, 40 years for health surveillance.
...
Our [Basic and Pro compliance kits](/kits/) include professionally structured COSHH assessment templates tailored to common trades — cleaning, construction, beauty, landscaping, and more. Each template comes pre-populated with the most common substances for your industry, with space to add your own. You fill in the specifics, print or save the document, and you have a compliant COSHH assessment ready for inspection.

It is not about cutting corners. It is about not having to start from a blank page.

**Ready to get your COSHH assessments sorted?** [View our compliance kits](/kits/) or [download a free sample](/free-sample/) to see exactly what you will get.
