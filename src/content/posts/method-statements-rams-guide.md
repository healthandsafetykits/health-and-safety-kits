...
For a deeper look at risk assessments specifically, see our [guide to health and safety risk assessments](/blog/health-and-safety-risk-assessment-guide/).
...
1. Scaffolding contractor to erect scaffold to front elevation in accordance with TG20 guidance
2. Scaffold to be inspected by competent person before use
3. Scaffold tag to be displayed confirming inspection date and next inspection due
4. All operatives to check scaffold each morning before use
...
1. **Eliminate** — can you remove the hazard entirely?
2. **Substitute** — can you use something less hazardous?
3. **Engineering controls** — physical barriers, guardrails, ventilation
4. **Administrative controls** — safe systems of work, training, signage, permits
5. **PPE** — personal protective equipment (always the last resort)
...
1. Set up work area and lay down dust sheets
2. Isolate existing boiler (gas, water, electrical)
3. Drain down existing system
4. Disconnect and remove existing boiler
5. Prepare wall for new boiler (make good, install fixings)
6. Mount new boiler on wall
7. Connect gas supply
8. Connect water supply (flow, return, hot water, cold water)
9. Connect condensate drain
10. Connect flue
11. Connect electrical supply
12. Fill and pressurise system
13. Commission boiler according to manufacturer's instructions
14. Test all connections for leaks
15. Complete benchmark certificate and Gas Safe notification
16. Clean up and remove waste
...
Writing method statements for every job takes time. Our [compliance kits](/kits/) include pre-built method statement templates for common tasks — just customise for your specific project and you're ready to go.
...
See what a professional method statement looks like — download our [free sample](/free-sample/).
...
- **Vague:** "Appropriate PPE to be worn"
- **Specific:** "Safety boots (S3 rated), hard hat, hi-vis vest, and safety glasses to be worn in the work area at all times. RPE (FFP3 disposable mask) to be worn during demolition and chasing activities"

- **Vague:** "Materials to be handled safely"
- **Specific:** "Plasterboard sheets (weight approx. 25kg each) to be carried by two persons. Stored flat on trestles, maximum stack height 1.2m"
...
For a broader look at what compliance documents you should have in place, see our [health and safety compliance checklist](/blog/health-and-safety-compliance-checklist/).
...
1. **A method statement describes how you'll do a job safely, step by step.** It's not a risk assessment — that's the companion document that identifies hazards. Together, they form your RAMS.

2. **You'll need RAMS for most contract work.** Main contractors, councils, commercial clients, and increasingly domestic clients expect them. Even where they're not explicitly required by law, they demonstrate competence and protect you.

3. **CDM 2015 applies to all construction work in the UK** — including domestic projects. Method statements are a core part of meeting your CDM duties.

4. **In Ireland, safe systems of work plans serve the same purpose.** The legislation is different, but the practical requirements are very similar.

5. **The key to a good method statement is specificity.** It must describe the actual job, at the actual site, with the actual hazards. Generic copy-paste documents aren't worth the paper they're printed on.

6. **Don't forget the briefing.** Writing the method statement is only half the job. Everyone doing the work needs to know what's in it.

7. **Keep it proportionate.** A simple job needs a simple method statement. A complex, high-risk job needs more detail. Match the effort to the risk.

8. **Update it when things change.** A method statement is a living document. If the job changes, the method statement changes with it.
...
- **Check your risk assessments.** Method statements and risk assessments go hand in hand. If one's missing or out of date, the other is undermined. Our [risk assessment guide](/blog/health-and-safety-risk-assessment-guide/) can help.
