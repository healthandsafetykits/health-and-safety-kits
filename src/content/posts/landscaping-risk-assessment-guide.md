...
If you are new to risk assessments in general, start with our [complete risk assessment guide for small businesses](/blog/health-and-safety-risk-assessment-guide/). For a broader look at health and safety obligations specific to the landscaping trade, see our guide on [health and safety for landscaping businesses](/blog/health-and-safety-for-landscaping-businesses/). This article focuses specifically on what goes into a landscaping risk assessment and how to write one that will satisfy both your legal obligations and a visiting inspector.
...
**Our [Landscaping Kit](/kits/landscaping/) is available now** — it includes ready-to-use COSHH assessment templates pre-populated for 8 common landscaping chemicals. **[View the kit](/kits/landscaping/) or [download a free sample](/free-sample/) to see the quality.**
...
For a broader checklist of compliance essentials, see our [health and safety compliance checklist](/blog/health-and-safety-compliance-checklist/).
...
**Looking for a kit that gives you everything in one place — risk assessment templates, COSHH assessments, policies, method statements, and checklists, all tailored for landscaping?** Visit our [kits page](/kits/) to compare what is available and find the right fit for your business.
