...
## Legal Requirements for Landscaping Businesses
...
- **Health and safety policy** (UK) or **safety statement** (Ireland) — your overarching document setting out your commitment to health and safety, the organisation and arrangements for managing it. In the UK, if you employ five or more people, this must be in writing. In Ireland, every employer must have a written safety statement. Even if you are a sole trader or employ fewer than five, having a written policy is essential for winning commercial contracts. Our [health and safety policy guide](/blog/health-and-safety-policy-guide/) explains exactly how to write one. If you are a sole trader wondering whether you even need one, read our guide on [whether sole traders need a health and safety policy](/blog/do-i-need-health-and-safety-policy-sole-trader/).
- **Risk assessments** — covering every significant activity you carry out: mowing, strimming, hedge cutting, tree work, chemical application, manual handling, driving and towing, and working at height. Our [risk assessment guide](/blog/health-and-safety-risk-assessment-guide/) covers the process step by step.
- **COSHH assessments** — one for every hazardous substance you use or may be exposed to. This includes herbicides, pesticides, fertilisers, petrol, diesel, two-stroke mix, chain oil, hydraulic fluid, cement, wood preservatives, and anything else with a safety data sheet. Our [COSHH assessment guide](/blog/coshh-assessment-guide/) walks you through the process.
...
That is a significant list. If you want to check what you already have in place and identify the gaps, our [health and safety compliance checklist](/blog/health-and-safety-compliance-checklist/) is the best place to start.
...
Our [COSHH assessment guide](/blog/coshh-assessment-guide/) explains the process in full.

**Our [Landscaping Kit](/kits/landscaping/) is available now — 19 professional compliance documents pre-filled for landscaping businesses. [View the kit](/kits/landscaping/) or [download a free sample](/free-sample/).**
...
- **Chainsaw** — **6 to 15 m/s2** depending on make, model, and condition.
- **Strimmer/brush cutter** — **3 to 8 m/s2**.
- **Hedge cutter** — **3 to 7 m/s2**.
- **Leaf blower (hand-held)** — **2 to 6 m/s2**.
- **Plate compactor** — **5 to 15 m/s2**.
