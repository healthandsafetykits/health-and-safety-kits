...
featured: false
excerpt: "Your employers' liability insurance and your H&S compliance are directly linked. Poor documentation can void your cover or increase premiums. Here's what insurers actually need from you."
---
...
If you are new to health and safety obligations generally, start with our [complete guide to health and safety for small businesses](/blog/health-and-safety-for-small-businesses-uk/). This article builds on that foundation and focuses specifically on the insurance connection.
...
This is the most important document. Your [risk assessments](/blog/health-and-safety-risk-assessment-guide/) demonstrate that you have identified the hazards in your workplace, assessed who could be harmed and how, and put control measures in place.
...
Under the **Health and Safety at Work etc. Act 1974 (HSWA)**, any employer with **five or more employees** must have a written [health and safety policy](/blog/health-and-safety-policy-guide/). Even if you have fewer than five employees, having a written policy demonstrates to your insurer that you take your obligations seriously.
...
For higher-risk activities, [method statements](/blog/health-and-safety-documents-for-tenders/) (sometimes called safe systems of work) describe step-by-step how a task should be carried out safely. They are particularly relevant for:
...
**Need H&S documentation your insurer will accept?** Our [trade-specific kits](/kits/) include everything listed above — pre-filled and professional. Risk assessments, COSHH assessments, training records, H&S policy, accident book templates, and method statements, all tailored to your trade and ready to use.
...
For a full overview of how to prepare your compliance documentation, see our [health and safety compliance checklist](/blog/health-and-safety-compliance-checklist/).
...
Missing any of these can mean losing the tender, regardless of how competitive your price is. We cover this in detail in our guide to [health and safety documents for tenders](/blog/health-and-safety-documents-for-tenders/).
...
[Download a free sample](/free-sample/) to see the quality, or [compare all kits](/kits/) to find the right documentation package for your trade.
